...
function tintImage(imgPath, newPath) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
...
function imageMetadata(imgPath) {
    return __awaiter(this, void 0, void 0, function () {
        var metadata;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, sharp_1.default)(imgPath).metadata()];
                case 1:
                    metadata = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, sharp_1.default)("sammy.png").metadata()];
                case 1:
                    metadata = _a.sent();
                    console.log(metadata);
                    return [3 /*break*/, 3];
